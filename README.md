...
| Plugin | Description |
|--------|-------------|
| **codex-review** | Consensus code review through deliberation between Claude and Codex. Both models independently review code, then debate findings until they agree. See [evaluation results](plugins/codex-review/evaluaions/results.md).<br>Requires [codex](https://github.com/openai/codex) installed. |
